...
class Terminal:
    ...
    def get_dec_mode(
        self,
        mode: Union[int, DecPrivateMode],
        timeout: Optional[float] = ...,
        force: bool = ...
    ) -> DecModeResponse: ...
    def dec_modes_enabled(
        self,
        *modes: Union[int, DecPrivateMode],
        timeout: Optional[float] = ...
    ) -> ContextManager[None]: ...
    def dec_modes_disabled(
        self,
        *modes: Union[int, DecPrivateMode],
        timeout: Optional[float] = ...
    ) -> ContextManager[None]: ...
    def does_sixel(self, timeout: Optional[float] = ...) -> bool: ...
    ...
    def get_kitty_keyboard_state(
        self,
        timeout: Optional[float] = ...,
        force: bool = ...
    ) -> Optional[Any]: ...
    def modify_other_keys(self, level: int = ...) -> ContextManager[None]: ...
