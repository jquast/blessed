...
*next release*
  ...
  * bugfix: for missing leading sequences in :meth:`Terminal.center`, :meth:`Terminal.wrap()`, and
    fixed for emojis containing Zero Width Joiner (`\u200D`) or Variation Selector-16 (`\uFE0F`),
    :ghpull:`338`
