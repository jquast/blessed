...
setuptools.setup(
    ...
    description=('Easy, practical library for making terminal apps, an elegant, well-documented '
                 'interface to Colors, Keyboard input, and screen Positioning capabilities.'),
