...
OSC 9;4 (ConEmo protocol) is supported by Windows Terminal, ConEmu, and Ghostty (1.2.0+).
There is no detection query for it, so sequences are emitted unconditionally;
unsupported terminals silently ignore them.
